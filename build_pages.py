  ...
  <section class="record hairline" id="record">
    <div class="shell">
      <div class="sec-head center">
        ...
        <p class="sec-sub">Members&#39; own posts, the analysts&#39; callouts and a full daily recap, across stocks, options and futures.</p>
      </div>
      {PEEK}
